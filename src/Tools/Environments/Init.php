...
class Init extends ToolAbstract
{
	...
	public function init()
	{
		...
		$this->setName(__('Environments', 'wc1c-maincore'));
		$this->setDescription(__('Data about all current environments.', 'wc1c-maincore'));
	...
	public function filter_data_row_print($data)
	{
		...
		if(is_bool($data))
		{
			if($data)
			{
				$data = __('yes', 'wc1c-maincore');
			}
			else
			{
				$data = __('not', 'wc1c-maincore');
			}
		}
	...
	public function wp_data_output()
	{
		...
		$args = ['title' => __('WordPress environment', 'wc1c-maincore'), 'data' => $wp_data];
	...
	public function wc1c_data_output()
	{
		...
		$args = ['title' => __('WC1C environment', 'wc1c-maincore'), 'data' => $wc1c_data];
	...
	public function wc_data_output()
	{
		...
		$args = ['title' => __('WooCommerce environment', 'wc1c-maincore'), 'data' => $wp_data];
	...
	public function server_data_output()
	{
		...
		$args = ['title' => __('Server environment', 'wc1c-maincore'), 'data' => $server_data];
	...
	public function load_wp_data()
	{
		...
		(
			'title' => __('Home URL', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('Site URL', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('WordPress version', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('WordPress multisite', 'wc1c-maincore'),
			'description' => '',
			'data' => is_multisite()
		);
		...
		(
			'title' => __('WordPress debug', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('WordPress cron', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('WordPress language', 'wc1c-maincore'),
			'description' => '',
			'data' => get_locale()
		);
		...
		(
			'title' => __('WordPress memory limit', 'wc1c-maincore'),
			'description' => '',
	...
	public function load_server_data()
	{
		...
		(
			'title' => __('Server info', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('PHP version', 'wc1c-maincore'),
			'description' => '',
			'data' => PHP_VERSION
		);
		...
		(
			'title' => __('Database version', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('Suhosin', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('Fsockopen or curl enabled', 'wc1c-maincore'),
			'description' => '',
		...
		if(function_exists('curl_version'))
		{
			...
			(
				'title' => __('CURL info', 'wc1c-maincore'),
				'description' => '',
		...
		(
			'title' => __('Default timezone', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('PHP post max size', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('PHP max upload size', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('PHP max execution time', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('PHP max input vars', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('PHP soapclient enabled', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('PHP domdocument enabled', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('PHP gzip enabled', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('PHP mbstring enabled', 'wc1c-maincore'),
			'description' => '',
	...
	public function load_wc1c_data()
	{
		...
		(
			'title' => __('WC1C version', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('Upload directory', 'wc1c-maincore'),
			'description' => '',
		...
		try
		{
			...
			(
				'title' => __('Count extensions', 'wc1c-maincore'),
				'description' => '',
		...
		try
		{
			...
			(
				'title' => __('Count schemas', 'wc1c-maincore'),
				'description' => '',
				'data' => count($schemas)
			);
		}
		...
		try
		{
			...
			(
				'title' => __('Count tools', 'wc1c-maincore'),
				'description' => '',
				'data' => count($tools)
			);
		}
	...
	private function load_wc_data()
	{
		...
		(
			'title' => __('WooCommerce version', 'wc1c-maincore'),
			'description' => '',
			'data' => WC()->version
		);
		...
		(
			'title' => __('WooCommerce product types', 'wc1c-maincore'),
			'description' => '',
			'data' => $term_response
		);
		...
		(
			'title' => __('WooCommerce currency', 'wc1c-maincore'),
			'description' => '',
		...
		(
			'title' => __('WooCommerce currency symbol', 'wc1c-maincore'),
			'description' => '',
