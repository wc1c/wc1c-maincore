...
<h1><?php esc_html_e( 'Creating tables in the database', 'wc1c-maincore' ); ?></h1>
<p><?php esc_html_e( 'If continue, the required tables will be created in the database.', 'wc1c-maincore' ); ?></p>
